...
%     [pth,nam,ext] = spm_fileparts(ref);
    ...
    t1Data = niftiread(ref);
%     sliceshow(t1Data,[],'gray',[],[],'MRI: Click anywhere to navigate.'); drawnow
...
%         fprintf('Using %s to segment T1 and T2 images: %s %s\n', Template, ref, ref2);
        ...
        t2Data = niftiread(ref2);
%         sliceshow(t2Data,[],'gray',[],[],'MRI: T2. Click anywhere to navigate.'); drawnow
